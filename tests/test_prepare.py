...
def test_build_cache_and_memmap(tmp_path, monkeypatch) -> None:
    ...
    run_train = _write_run(tmp_path, video_id="video_train", camera_id="camera_train", raw_path="s3://bucket/train.mp4")
    run_val = _write_run(tmp_path, video_id="video_val", camera_id="camera_val", raw_path="s3://bucket/val.mp4")
